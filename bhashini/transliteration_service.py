...
class TransliterationService:
    def __init__(self, input_lang='devanagari', output_lang='iast'):
        self.input_lang = input_lang
        self.output_lang = output_lang

    def transliterate(self, text):
        return transliterate(text, self.input_lang, self.output_lang)

# Example usage
transliterator = TransliterationService()
transliterated_text = transliterator.transliterate("नमस्ते")
